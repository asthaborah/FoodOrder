...
<body
    style="background-color: #ff7d59;background-image: linear-gradient(319deg, #ff7d59 0%, #ff583a 37%, #f4a698 100%);">
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($res) {
            ...
            if ($count == 1) {
                ...
                $_SESSION["user-login"] = $username; // this session is created after login for access control 
